<script>
  ...
  async function loadGoogleAuth() {
    ...
    if (!clientId) {
      errorMessage =
        "Aggiungi VITE_GOOGLE_CLIENT_ID per abilitare il login con Google.";
      return;
    }
...
<div>
  {#if !$userEmail}
    <div class="signin-container">
      <article>
        <header>Funzionalità riservata ai docenti</header>
        ...
        {/if}
        <footer>
          <p>Accedi utilizzando il tuo account <b>@lscortese.com</b></p>
        </footer>
      </article>
    </div>
  {:else}
